                ...
                for vert, loop in zip(vertFaces, loopFaces):
                    ...
                    if(not exportNormal):
                        ...
                        if(norm.dot(poly.normal) < 0.0):
                            ...
                            loop = (loop[2], loop[1], loop[0])
                            
                    for idVert, idLoop in zip(vert, loop):
                        face += " "+str(idVert+1)
